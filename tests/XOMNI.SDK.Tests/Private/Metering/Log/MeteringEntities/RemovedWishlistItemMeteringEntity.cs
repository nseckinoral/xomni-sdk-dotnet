...
{
    public class RemovedWishlistItemMeteringEntity : BaseMeteringEntity
    {
        ...
        public RemovedWishlistItemMeteringEntity(DateTime meteringDate)
            : base(meteringDate)
        {

        }

        public RemovedWishlistItemMeteringEntity()
        {
