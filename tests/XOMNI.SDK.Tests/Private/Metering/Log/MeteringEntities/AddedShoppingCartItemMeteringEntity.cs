...
{
    public class AddedShoppingCartItemMeteringEntity : BaseMeteringEntity
    {
        ...
        public AddedShoppingCartItemMeteringEntity(DateTime meteringDate)
            : base(meteringDate)
        {

        }

        public AddedShoppingCartItemMeteringEntity()
        {
