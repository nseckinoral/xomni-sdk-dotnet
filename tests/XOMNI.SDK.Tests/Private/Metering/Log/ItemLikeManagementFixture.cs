...
{
    [TestClass]
    public class ItemLikeManagementFixture : BaseMeteringManagementFixture
    {
        [TestMethod]
        ...
        {
            get { return typeof(ItemLikeMeteringEntity); }
        }

        protected override Model.Private.Metering.CounterTypes CounterType
        {
            get { return Model.Private.Metering.CounterTypes.ItemLike; }
        }
    }
}
