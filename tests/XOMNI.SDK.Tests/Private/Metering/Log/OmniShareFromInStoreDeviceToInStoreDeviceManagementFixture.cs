...
{
    [TestClass]
    public class OmniShareFromInStoreDeviceToInStoreDeviceManagementFixture : BaseMeteringManagementFixture
    {
        ...
        [TestMethod]
        [TestCategory("SDK.Private.Metering.Log"), TestCategory("Integration"), TestCategory("SDK.Private.Metering.Log.OmniShareFromInStoreDeviceToInStoreDeviceMeteringManagement")]
