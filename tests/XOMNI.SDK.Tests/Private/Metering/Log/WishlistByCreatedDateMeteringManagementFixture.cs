...
{
    [TestClass]
    public class WishlistByCreatedDateMeteringManagementFixture : BaseMeteringManagementFixture
    {
        ...
        {
            get { return typeof(WishlistByCreatedDateMeteringEntity); }
        }

        [TestMethod]
        [TestCategory("SDK.Private.Metering.Log"), TestCategory("Integration"), TestCategory("SDK.Private.Metering.Log.WishlistByCreatedDateMeteringManagement")]
